(function () {
  ...
  function translateToEnglish() {
    ...
    info.textContent =
      "My name is Nicolas Ribeiro, I live in São Paulo. I am graduate in Systems Analysis and Development at Universidade Cidade de São Paulo (UNICID), and it was there that I made my first line of code, since then I've been falling in love and learning more and more in the area, I intend to continue with Front-End development and studying software engineering.";
    //skills translate
